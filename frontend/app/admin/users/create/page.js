...
import { createUser, fetchUsers } from "@/redux/features/users/usersThunks"
...
export default function CreateUser() {
  ...
  const peers = users.filter((u) => u._id !== formData.manager)
  const potentialJuniors = users.filter((u) => u.role === "staff")
